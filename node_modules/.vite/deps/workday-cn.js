...
// node_modules/workday-cn/lib/workday-cn.esm.js
var HOLIDAYS_2018 = [
  "2018-02-15",
  // 春节
  "2018-02-16",
...
function getWorkdays(date, type = "week") {
  ...
  const d = new Date(date);
  const start = type === "week" ? new Date(d.setDate(d.getDate() - d.getDay())) : new Date(d.getFullYear(), d.getMonth(), 1);
  const end = type === "week" ? new Date(d.setDate(d.getDate() + 6)) : new Date(d.getFullYear(), d.getMonth() + 1, 0);
...
workday-cn/lib/workday-cn.esm.js:
   ...
   *)
*/
//# sourceMappingURL=workday-cn.js.map
